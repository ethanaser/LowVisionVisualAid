...
public class YuvRenderer implements GLSurfaceView.Renderer {
     ...
     * 相机分辨率
     */
    private final static int DEFAULT_WIDTH = 1920, DEFAUTL_HEIGHT = 1080;
    ...
    private int program;
    private int positionLocation, texcoordLocation, mvpLocation, quatLoaction, yTextureLocation, uTextureLocation, vTextureLocation;
    int mmUserMode, mmSaturation, mmContrast, mmBrightness, piexlSize, aryWeight, aryOffset, scaleFactor, offsetBase;
    private int[] yTextureId = {0}, uTextureId = {0}, vTextureId = {0}, texStab = {0};
    private FloatBuffer vertexLeftBuffer, vertexRightBuffer, texcoordBuffer;
    //    private boolean isReady;
    long lastMills;

    private void initProgram() {
        program = ShaderUtils.loadShader(YUVShaderCode.VERTEXCODE1, YUVShaderCode.FRAGMENTCODE_YUV);
//        isReady = false;
...
//            texcoordBuffer = createFloatBuffer(TEXTURE_COORS.length * 4);
    ...
    private void initLocation() {
        ...
        yTextureLocation = GLES20.glGetUniformLocation(program, "s_textureY");
        uTextureLocation = GLES20.glGetUniformLocation(program, "s_textureU");
        vTextureLocation = GLES20.glGetUniformLocation(program, "s_textureV");
...
//            Matrix.rotateM(mvpMatrix1, 0, 180, 0.0f, 0.0f, 1.0f);
    ...
    int yWidth, yHeight, uWidth, uHeight;

    private void createTextures() {
        yWidth = width;
        yHeight = height;
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
        GLES20.glGenTextures(1, yTextureId, 0);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, yTextureId[0]);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S, GLES32.GL_CLAMP_TO_BORDER);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_T, GLES32.GL_CLAMP_TO_BORDER);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE, yWidth, yHeight, 0, GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE,
                null);
        uWidth = width / 2;
        uHeight = height / 2;
        GLES20.glActiveTexture(GLES20.GL_TEXTURE1);
        GLES20.glGenTextures(1, uTextureId, 0);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, uTextureId[0]);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S, GLES20.GL_CLAMP_TO_EDGE);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_T, GLES20.GL_CLAMP_TO_EDGE);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE, uWidth, uHeight, 0, GLES20.GL_LUMINANCE, GLES20.GL_UNSIGNED_BYTE,
                null);
//            int vWidth = width / 2;
//            int vHeight =height / 2;
        GLES20.glActiveTexture(GLES20.GL_TEXTURE2);
        GLES20.glGenTextures(1, vTextureId, 0);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, vTextureId[0]);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S, GLES20.GL_CLAMP_TO_EDGE);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_T, GLES20.GL_CLAMP_TO_EDGE);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR);
        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
...
//        GLES20.glGenTextures(1, texStab, 0);
//        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, texStab[0]);
//        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_S, GLES20.GL_CLAMP_TO_EDGE);
//        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_WRAP_T, GLES20.GL_CLAMP_TO_EDGE);
//        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR);
//        GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
//        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_RGBA, yWidth, yHeight, 0, GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE,
//                null);
    }
...
//            Log.d("TAG", "onDrawFrame: ++" + (System.currentTimeMillis() - currentMills));
    ...
    private void updateTextures() {
        ...
        GLES20.glActiveTexture(GLES20.GL_TEXTURE0);
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, yTextureId[0]);
        GLES20.glTexImage2D(GLES20.GL_TEXTURE_2D, 0, GLES20.GL_LUMINANCE, yWidth,
                yHeight, 0,
...
//        saturationValue = 1.0f + (this.saturation - 1) * 0.4f;
    ...
    public void updateImage(byte[] y, byte[] u, byte[] v) {
...
//        Matrix.scaleM(this.mvpMatrixRight, 0, scale, scale, 1.0f);
    ...
    public void setIpd(int ipd) {
        ...
        Matrix.scaleM(this.mvpMatrixLeft, 0, leftScale, leftScale, 1.0f);
        Matrix.scaleM(this.mvpMatrixRight, 0, rightScale, rightScale, 1.0f);
        ...
        Matrix.translateM(this.mvpMatrixLeft, 0, -translateIpd, 0.0f, 0.0f);
        Matrix.translateM(this.mvpMatrixLeft, 0, leftX, leftY, 0.0f);
        Matrix.translateM(this.mvpMatrixRight, 0, translateIpd, 0.0f, 0.0f);
        Matrix.translateM(this.mvpMatrixRight, 0, rightX, rightY, 0.0f);
        if (fastScaleTag == 1) {
            if (leftFastScale != null) {
    ...
    public void setPhotoView(Bitmap bitmap) {
        ...
        byte[] yuv = ImageConvertUtils.getYUVByBitmap(bitmap);
        ...
        int index = 0;
        for (int i = ysize; i < yuv.length; i++) {
            if (i % 2 == 0) {
                v[index] = yuv[i];
                index++;
            } else {
...
//            updateImage(y, u, v);
            if (freezeMode == 1) {
                ...
                updateImage(lastY, lastU, lastV);
                if (this.onFrameListener != null) {
                    this.onFrameListener.onYuvFrame(currentYuv, freezeScale);
                }
            } else {
                currentYuv = yuv;
                updateImage(y, u, v);
                if (this.onFrameListener != null) {
                    this.onFrameListener.onYuvFrame(currentYuv, getScale());
                }
            }
...
//            Log.d("TAG", "saveBitmap: +++++" + (System.currentTimeMillis() - currentMills));
    ...
    //根据放大倍数切换接收数据的接口
    public void onPreviewFrame1(byte[] yuv) {
        if (getScale() < 2) return;
        if (isPhotoView) return;
        if (yuv != null) {
//            currentMills = System.currentTimeMillis();
            System.arraycopy(yuv, 0, y, 0, ysize);
            System.arraycopy(yuv, ysize, v, 0, uvsize);
            System.arraycopy(yuv, ysize + uvsize, u, 0, uvsize);
//            updateImage(y, u, v);
            if (freezeMode == 1) {//3110400
                if (freezeStart == 0) {
                    freezeStart = 1;
                    lastY = new byte[y.length];
                    lastU = new byte[u.length];
