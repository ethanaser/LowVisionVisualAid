...
enum
{
    // modes of the controlling registers (can be: auto, manual, auto single push, absolute Latter allowed with any other ColorMode)
    ...
    // PVAPI
    CV_CAP_PROP_PVAPI_MULTICASTIP           = 300, // ip for anable multicast master ColorMode. 0 for disable multicast
    ...
    CV_CAP_PROP_XI_GPI_MODE                                     = 407, // Set general purpose input ColorMode
    CV_CAP_PROP_XI_GPI_LEVEL                                    = 408, // Get general purpose level
    CV_CAP_PROP_XI_GPO_SELECTOR                                 = 409, // Selects general purpose output
    CV_CAP_PROP_XI_GPO_MODE                                     = 410, // Set general purpose output ColorMode
    ...
    CV_CAP_PROP_XI_REGION_SELECTOR                              = 589, // Selects Region in Multiple ROI which parameters are set by width, height, ... ,region ColorMode
    ...
    CV_CAP_PROP_XI_SENSOR_MODE                                  = 558, // Current sensor ColorMode. Allows to select sensor ColorMode by one integer. Setting of this parameter affects: image dimensions and downsampling.
...
enum
{
    CV_CAP_PROP_GPHOTO2_PREVIEW           = 17001, // Capture only preview from liveview ColorMode.
    ...
    CV_CAP_PROP_VIEWFINDER                = 17010  // Enter liveview ColorMode.
};
