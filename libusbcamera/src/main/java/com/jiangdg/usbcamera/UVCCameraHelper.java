...
public class UVCCameraHelper {
    ...
    public static final int MODE_ZOOM_ABS = UVCCamera.CTRL_ZOOM_ABS;
    public static final int MODE_BACKLIGHT = UVCCamera.PU_BACKLIGHT;//焦距-原背光补偿
    public static final int MODE_SATURATION = UVCCamera.PU_SATURATION;//饱和度
...
//                        setModelValue(UVCCameraHelper.MODE_BRIGHTNESS, 90);
//                        setModelValue(UVCCameraHelper.MODE_SATURATION, 90);
//                        setModelValue(UVCCameraHelper.MODE_CONTRAST, 90);
                    }
                }).start();
                if (listener != null) {
    ...
    public void createUVCCamera() {
        ...
        mCameraHandler.addCallback(new AbstractUVCCameraHandler.CameraCallback() {
            @Override
            public void onOpen() {
                Log.d(TAG, "onOpen: times:" + System.currentTimeMillis());
            }

            @Override
            public void onClose() {
                Log.d(TAG, "onClose: times:" + System.currentTimeMillis());
            }

            @Override
            public void onStartPreview() {
                Log.d(TAG, "onStartPreview: times:" + System.currentTimeMillis());

            }

            @Override
            public void onStopPreview() {
                Log.d(TAG, "onStopPreview: times:" + System.currentTimeMillis());
